...
with open(Path("response.json"), "rb") as response:
    ...
    for item in items:
        ...
        for question in questions:
            ...
            answers = {
                answer["value"]: answer["label"] for answer in question["options"]
            }
            ...
            if "custom_distractor_rationale_response_level" in question["metadata"]:
                rationaleList = question["metadata"][
                    "custom_distractor_rationale_response_level"
                ]
            ...
            print(
                f"{Style.RESET_ALL}{Style.BRIGHT + Fore.RED}{i}. {Style.RESET_ALL}{questionText}"
            )
